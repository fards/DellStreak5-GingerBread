...
static void msmsdcc_power(int on)
{
    ...
    if (on)
    {
        gpio_tlmm_config(GPIO_CFG(106, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_set_value(106, 0);
        gpio_tlmm_config(GPIO_CFG(88, 1, GPIO_OUTPUT, GPIO_NO_PULL, GPIO_8MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(89, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(90, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(91, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(92, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(93, 1, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_8MA), GPIO_ENABLE);
        printk(KERN_DEBUG "[SDCC] power on\n");
    }
    else
    {
        gpio_tlmm_config(GPIO_CFG(88, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(89, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(90, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(91, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(92, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(93, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA), GPIO_ENABLE);
        gpio_tlmm_config(GPIO_CFG(106, 0, GPIO_OUTPUT, GPIO_PULL_UP, GPIO_2MA), GPIO_ENABLE);
